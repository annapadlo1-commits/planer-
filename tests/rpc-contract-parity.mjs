...
import { classifyInventory } from "../scripts/rpc-contract/parity-core.mjs";
...
test("restored staffing RPC is fail-closed, atomic and rejects an invalid final count", () => {
  const sql = readFileSync(new URL("../supabase/migrations/20260826220734_restore_frontend_rpc_parity.sql", import.meta.url), "utf8");
