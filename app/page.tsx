...
import {
  ...
  Menu, Plus, RefreshCw, Settings, Users, WandSparkles, Wifi, X,
} from "lucide-react";
...
type NavKey = "centrum"|"generator"|"grafik"|"kalendarz"|"pracownicy"|"alerty"|"budzet";
...
export default function GrafikPro() {
  ...
  const load=useCallback(async()=>{
    ...
    const result=await supabase.rpc("plan_workspace",{p_month:MONTH,p_plan_id:null});
