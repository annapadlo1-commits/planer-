...
function swapReasonLabel(value?: string) { return ({ ROLE_REQUIRED: "Brak wymaganej roli", LOCATION_NOT_ALLOWED: "Lokal nie jest dozwolony", DUTY_REQUIRED: "Brak wymaganej kompetencji i zastępczego pokrycia na zmianie", HARD_UNAVAILABLE: "Twarda niedostępność", STANDBY_CONFLICT: "Stand-by tego dnia", SHIFT_OR_REST_CONFLICT: "Kolizja grafiku lub odpoczynku", MAXIMUM_MONTHLY_HOURS: "Przekroczenie limitu miesięcznego", MAXIMUM_WEEKLY_HOURS: "Przekroczenie limitu tygodniowego", OUTSIDE_EMPLOYMENT:"Data poza okresem zatrudnienia", NO_WEEKENDS:"Zablokowane weekendy", ONLY_MORNING:"Dozwolone tylko poranki", ONLY_EVENING:"Dozwolone tylko wieczory", CANNOT_SWAP_WITH_SELF:"Nie można zamienić się ze sobą" } as Record<string, string>)[value || ""] || value || "Ta zamiana nie spełnia twardych reguł."; }
