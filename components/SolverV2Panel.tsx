  ...
  return <div className="solver-v2-panel">
    ...
    {leaderVariant&&selectedWorkspace&&<section className="leader-studio-fullscreen" role="dialog" aria-modal="true" aria-label="Studio lidera">
      ...
      {leaderWorkflow==="DRAFT"&&<section className="leader-assistant-tools" aria-label="Opcjonalne narzędzia generatora">
        {selectedVariant&&selectedVariant.unfilledCount>0&&<details className="leader-assistant-tool leader-refill-action">
        ...
        <details className="leader-assistant-tool leader-optimization-action">
