-- Reserve two eligible off-duty employees per role/day in every new solver snapshot.
-- The worker treats this as a hard capacity constraint; publication then assigns
-- deterministic Tier 1/Tier 2 identities and preserves them in the audit trail.
